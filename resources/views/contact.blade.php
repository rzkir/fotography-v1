<x-layout.public title="Noir/Studio - Contact & Information">
    <div class="min-h-screen relative overflow-hidden bg-[#0d0d0d]">
        ...
        <main class="relative pt-28 z-10 space-y-24">
            <!-- Hero Section -->
            <section id="hero" class="asymmetric-grid px-6 md:px-12" data-aos-hero>
                <div class="col-span-12 lg:col-span-8 pr-12">
                    <div class="relative">
                        <span class="text-xs font-bold tracking-[0.5em] text-zinc-500 uppercase" data-aos="fade-down" data-aos-offset="0">Contact & Information</span>
                        <h1 class="text-8xl lg:text-[11rem] font-display font-black leading-[0.8] tracking-tighter uppercase mb-8" data-aos="fade-right" data-aos-delay="80" data-aos-offset="0">Studio<br/>Noir</h1>
                        <p class="font-serif italic text-4xl lg:text-5xl text-zinc-400 leading-tight max-w-2xl" data-aos="fade-right" data-aos-delay="160" data-aos-offset="0">A space for artistic collaboration, dedicated to <span class="text-[#f5f2ed] border-b border-zinc-700">immortalizing</span> the human essence through the medium of light.</p>
                    </div>
                </div>
            </section>

            <!-- Methods Section -->
            <section id="methods" class="px-6 md:px-12">
                <div class="asymmetric-grid">
                    <div class="col-span-12 lg:col-span-4 space-y-16" data-aos="fade-right">
                        <div class="space-y-6">
                            <div>
                                <h4 class="text-xs font-bold uppercase tracking-widest text-zinc-500 mb-6">Department Contacts</h4>
                                <div class="space-y-8">
                                    <div class="group border-b border-zinc-900 pb-4">
                                        <p class="text-xs text-zinc-600 uppercase mb-2">Bookings & Inquiries</p>
                                    ...
                                    <div class="group border-b border-zinc-900 pb-4">
                                        <p class="text-xs text-zinc-600 uppercase mb-2">Press & Media</p>
                                    ...
                                    <div class="group border-b border-zinc-900 pb-4">
                                        <p class="text-xs text-zinc-600 uppercase mb-2">Collaborations</p>
                        ...
                        <div class="space-y-6">
                            <div>
                                <h4 class="text-xs font-bold uppercase tracking-widest text-zinc-500 mb-4">Telecommunications</h4>
                                ...
                                <p class="text-xs text-zinc-600 mt-2 uppercase">Available for WhatsApp & Signal</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-12 lg:col-span-7 lg:col-start-6" data-aos="fade-left" data-aos-delay="100">
                        <div class="bg-zinc-900/50 p-12 lg:p-16 border border-zinc-800 rounded-sm">
                            <h4 class="text-xs font-bold uppercase tracking-widest text-zinc-500 mb-8">The Studio Experience</h4>
            ...
            <!-- Guarantees -->
            <section id="guarantees" class="py-12 border-y border-zinc-900">
                <div class="text-center px-6 md:px-12">
                    <h4 class="text-xs font-bold uppercase tracking-[0.5em] text-zinc-500 mb-12" data-aos="fade-up">Our Commitment</h4>
            ...
            <section id="photographer" class="">
                <div class="asymmetric-grid">
                    ...
                    <div class="col-span-12 lg:col-span-6 lg:col-start-7 flex flex-col justify-center" data-aos="fade-left" data-aos-delay="100">
                        <span class="text-xs font-bold tracking-[0.5em] text-zinc-500 uppercase block mb-8">Lead Photographer</span>
                        ...
                        <div class="grid grid-cols-2 gap-12 mt-16">
                            <div class="space-y-4">
                                <h5 class="text-xs font-bold uppercase text-zinc-600 tracking-widest">Awards</h5>
                            ...
                            <div class="space-y-4">
                                <h5 class="text-xs font-bold uppercase text-zinc-600 tracking-widest">Features</h5>
                                <ul class="text-xs space-y-2">
            ...
            <!-- Team -->
            <section id="team" class="py-20 bg-zinc-950 px-12">
                    <div class="flex flex-col mb-16" data-aos="fade-up">
                        <span class="text-xs font-bold tracking-[0.5em] text-zinc-500 uppercase mb-4">The Collective</span>
                    ...
                    <div class="grid md:grid-cols-3 gap-12">
                        <div class="group space-y-6" data-aos="fade-up" data-aos-delay="0">
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-xs font-bold uppercase tracking-widest text-zinc-500">Lead Stylist / 8 Years Exp.</p>
                        ...
                        <div class="group space-y-6" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-xs font-bold uppercase tracking-widest text-zinc-500">Makeup & Hair Artist</p>
                        ...
                        <div class="group space-y-6" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-xs font-bold uppercase tracking-widest text-zinc-500">Lighting Tech & Digital Op</p>
            ...
            <!-- Services -->
                <section id="services" class="px-6 md:px-12">
            ...
            <!-- Testimonials -->
            <section id="testimonials" class="py-12 bg-white text-black">
                <div class="px-6 md:px-12">
                    <span class="text-xs font-bold tracking-[0.5em] text-zinc-400 uppercase block mb-8" data-aos="fade-up">Client Voices</span>
                    <div class="grid md:grid-cols-2 gap-x-24 gap-y-16">
                        <div class="space-y-4" data-aos="fade-up" data-aos-delay="0">
                            ...
                            <div class="pt-4">
                                ...
                                <p class="text-xs uppercase text-zinc-400">Fine Art Session</p>
                            </div>
                        </div>
                        <div class="space-y-4" data-aos="fade-up" data-aos-delay="100">
                            <iconify-icon icon="material-symbols:format-quote-rounded" class="text-4xl text-zinc-200"></iconify-icon>
                            ...
                            <div class="pt-4">
                                ...
                                <p class="text-xs uppercase text-zinc-400">Brand Creative Director</p>
                            </div>
                        </div>
                        <div class="space-y-4" data-aos="fade-up" data-aos-delay="200">
                            <iconify-icon icon="material-symbols:format-quote-rounded" class="text-4xl text-zinc-200"></iconify-icon>
                            ...
                            <div class="pt-4">
                                ...
                                <p class="text-xs uppercase text-zinc-400">Fashion Designer</p>
                            </div>
                        </div>
                        <div class="space-y-4" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div class="pt-4">
                                ...
                                <p class="text-xs uppercase text-zinc-400">Architectural Designer</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- FAQ -->
            <section id="faq" class="px-6 md:px-12">
                <div class="text-center mb-20" data-aos="fade-up">
                    <span class="text-xs font-bold tracking-[0.5em] text-zinc-500 uppercase mb-4">Q&A</span>
                    <h2 class="text-5xl font-display font-black uppercase">Booking FAQ</h2>
                </div>
                <div class="space-y-12">
                    <div class="border-b border-zinc-900 pb-8" data-aos="fade-up" data-aos-delay="0">
                    ...
                    <div class="border-b border-zinc-900 pb-8" data-aos="fade-up" data-aos-delay="50">
                    ...
                    <div class="border-b border-zinc-900 pb-8" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="border-b border-zinc-900 pb-8" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <div class="border-b border-zinc-900 pb-8" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="border-b border-zinc-900 pb-8" data-aos="fade-up" data-aos-delay="250">
            ...
            <!-- Press Kit -->
            <section id="press-kit" class="bg-zinc-900/30 py-12 border-t border-zinc-900">
                <div class="px-6 md:px-12 flex flex-col lg:flex-row justify-between items-center gap-12">
                    <div class="max-w-xl" data-aos="fade-right">
                        <h4 class="text-xs font-bold uppercase tracking-[0.5em] text-zinc-500 mb-6">Media Assets</h4>
                    ...
                    <div class="flex space-x-12" data-aos="fade-left" data-aos-delay="100">
                        <div class="text-center">
                            <p class="text-4xl font-display font-black">45K</p>
                            <p class="text-xs uppercase text-zinc-500 tracking-widest mt-2">Followers / IG</p>
                        </div>
                        <div class="text-center">
                            <p class="text-4xl font-display font-black">120</p>
                            <p class="text-xs uppercase text-zinc-500 tracking-widest mt-2">Awards Won</p>
                        </div>
                        <div class="text-center">
                            <p class="text-4xl font-display font-black">500+</p>
                            <p class="text-xs uppercase text-zinc-500 tracking-widest mt-2">Client Sagas</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <!-- Marquee -->
            <div class="py-12 border-t border-zinc-900 overflow-hidden" data-aos="fade-up">
